...
def loadDataFile(filename, format_string='double'):
    ...
    if "VersionString" in header:
        ...
        major_version = version_string.tostring().decode('utf-8').split('.')[0]
        minor_version = version_string.tostring().decode('utf-8').split('.')[1]
        version = float(major_version +'.'+minor_version)  # ignore revisions
